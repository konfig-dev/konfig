...
open class TradingAPI {
     ...
     */
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func cancelUserAccountOrderAsync(
        userId: String,
        userSecret: String,
        accountId: UUID,
     ...
     */
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func getOrderImpactAsync(
        userId: String,
        userSecret: String,
        accountId: UUID? = nil, 
        action: Action? = nil, 
     ...
     */
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func getUserAccountQuotesAsync(
        userId: String,
        userSecret: String,
        symbols: String,
        accountId: String,
     ...
     */
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func placeForceOrderAsync(
        userId: String,
        userSecret: String,
        accountId: UUID? = nil, 
        action: Action? = nil, 
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func placeOCOOrderAsync(
        userId: String,
        userSecret: String,
     ...
     */
    @available(iOS 13.0, macOS 10.15, tvOS 13.0, watchOS 6.0, *)
    open class func placeOrderAsync(
        tradeId: UUID,
        userId: String,
        userSecret: String
    ) async throws -> AccountOrderRecord {
