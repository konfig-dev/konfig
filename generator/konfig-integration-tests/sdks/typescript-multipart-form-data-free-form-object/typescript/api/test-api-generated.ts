...
export const TestApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    uploadFiles: async (
      uploadFileRequestInner?: Array<UploadFileRequestInner>,
      ...
      const addFormParam = async (
        ...
        if (isBinary) {
          if (data instanceof Uint8Array) {
            ...
            const filename =
              filetype === undefined ? name : `${name}.${filetype.ext}`;
          ...
          if (isPrimitiveType) {
             ...
             * non-string primitives to string.
             */
...
export const TestApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     */
    async uploadFiles(
      requestParameters: TestApiUploadFilesRequest,
      options?: AxiosRequestConfig
    ): Promise<
...
export const TestApiFactory = function (
  ...
  return {
    ...
    uploadFiles(
      ...
      return localVarFp
        .uploadFiles(requestParameters, options)
