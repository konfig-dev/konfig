...
from python_invalid_response.paths.object_instead_of_list import get
from python_invalid_response import configuration, schemas, api_client

from .. import ApiTestMixin


class TestObjectInsteadOfList(ApiTestMixin, unittest.TestCase):
    """
    ObjectInsteadOfList unit test stubs
    """
