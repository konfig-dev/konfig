...
from test_timeout_bug.exceptions_base import ApiValueError
from test_timeout_bug.exceptions import ClientConfigurationError
...
conf = test_timeout_bug.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://test-timeout-bug.konfigthis.com" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("test_timeout_bug")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://test-timeout-bug.konfigthis.com",
