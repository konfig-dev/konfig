...
const pythonResponseTypeVersion2 = z
  .literal('2')
  .describe(
    'Responses are Pydantic instances and do not include all HTTP response fields in the response object. To get raw HTTP repsonse fields, use the *_raw version of the method.'
  )
