...
title: "The Power of Code Generation: From Low-Level Programming to AI Assistants"
authors: dylan
...
generation omnipresent in every part of the stack? In this post, we will do
...
When the first electrical computers were created, the most archaic form of
computer programming was used, switches! Physical switches are extremely
error-prone and time-consuming to operate so with the invention of the CPU and
machine code instruction set, a new type of programming language was invented
called assembly.
...
Instead of using laborious physical switches, we can simply write a series of
instructions for the computer to execute. Still, assembly instructions are
tedious and error-prone, so higher-level programming languages were invented
...
I am glad that we don't have to write assembly anymore  😮‍💨.
