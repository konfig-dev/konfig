...
## What if I stop using Konfig SDKs?

If you stop using Konfig SDKs, you will no longer have access to updates. But we
offer a way to export your SDKs so your applications can continue to operate
